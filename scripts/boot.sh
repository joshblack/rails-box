...
fancy_echo "Setting permissions on shims so rbenv rehash will work properly ..."
  chmod -R 775 ~/.rbenv/shims

fancy_echo "Installing maximum-awesome for vim config files ..."
  git clone git://github.com/square/maximum-awesome.git
  rake

fancy_echo "Installing and starting up nginx ..."
